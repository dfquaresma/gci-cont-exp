...
# Table: Go Experiment
```{r}
gogci <- rbind(read.al("go", "gci", "11"),read.al("go", "gci", "13"),read.al("go", "gci", "14"))
gonogci <- rbind(read.al("go", "nogci", "11"),read.al("go", "nogci", "13"),read.al("go", "nogci", "14"))
gozero <- rbind(read.al("go", "zero", "11"),read.al("go", "zero", "13"),read.al("go", "zero", "14"))
