...
# Table: Go Experiment
```{r}
gogci <- rbind(read.al("go", "gci", "0"),read.al("go", "gci", "1"),read.al("go", "gci", "2"))
gonogci <- rbind(read.al("go", "nogci", "0"),read.al("go", "nogci", "1"),read.al("go", "nogci", "2"))
gozero <- rbind(read.al("go", "zero", "0"),read.al("go", "zero", "1"),read.al("go", "zero", "2"))
